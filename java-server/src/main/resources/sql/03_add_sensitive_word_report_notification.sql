...
CREATE TABLE IF NOT EXISTS bbs_report (
    ...
    target_type TINYINT(1) NOT NULL COMMENT '举报对象类型（1 = 帖子，2 = 评论，3 = 个人主页资料卡）',
    target_id BIGINT NOT NULL COMMENT '举报对象 ID',
    target_snapshot TEXT NULL DEFAULT NULL COMMENT '举报对象快照（JSON）',
    ...
    handle_type TINYINT(1) NULL DEFAULT NULL COMMENT '处理方式（1 = 删除内容，2 = 驳回举报，3 = 清空违规资料）',
