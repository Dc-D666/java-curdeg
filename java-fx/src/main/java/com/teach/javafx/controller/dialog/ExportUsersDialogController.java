...
public class ExportUsersDialogController {

    @FXML private CheckBox personIdFieldCheck;
    @FXML private CheckBox userNameFieldCheck;
    @FXML private CheckBox nicknameFieldCheck;
    @FXML private CheckBox studentIdFieldCheck;
    @FXML private CheckBox postCountFieldCheck;
    @FXML private CheckBox commentCountFieldCheck;
    @FXML private CheckBox isBannedFieldCheck;
    ...
    public boolean handleExport() {
        ...
        if (personIdFieldCheck.isSelected()) fields.add("personId");
        if (userNameFieldCheck.isSelected()) fields.add("userName");
        if (nicknameFieldCheck.isSelected()) fields.add("nickname");
        if (studentIdFieldCheck.isSelected()) fields.add("studentId");
        if (postCountFieldCheck.isSelected()) fields.add("postCount");
        if (commentCountFieldCheck.isSelected()) fields.add("commentCount");
        if (isBannedFieldCheck.isSelected()) fields.add("isBanned");
        ...
        Stage stage = (Stage) personIdFieldCheck.getScene().getWindow();
        ...
        Task<byte[]> exportTask = new Task<byte[]>() {
            @Override
            protected byte[] call() {
                DataResponse response = HttpRequestUtil.request("/api/admin/export/users", request);
